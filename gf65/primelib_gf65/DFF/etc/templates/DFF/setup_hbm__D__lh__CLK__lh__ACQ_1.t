...
## 
## Test setup_hbm__D__lh__CLK__lh
set tempTest [ SBTest "setup_hbm__D__lh__CLK__lh" ]
$tempTest setTargets { setup_hbm__D__lh__CLK__lh }
...
$tempWT setStimulus                            {   R    D    CLK  Q     } {
                               "0"          {} {   0    0    0    0     }
                   "initial_delay"     { in1 } {   -    1    -    -     }
           "(initial_delay)+setup" { in2 out } {   -    -    1    1     }
