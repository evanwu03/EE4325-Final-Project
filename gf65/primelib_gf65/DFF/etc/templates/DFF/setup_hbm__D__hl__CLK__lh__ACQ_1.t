...
## 
## Test setup_hbm__D__hl__CLK__lh
set tempTest [ SBTest "setup_hbm__D__hl__CLK__lh" ]
$tempTest setTargets { setup_hbm__D__hl__CLK__lh }
...
$tempWT setStimulus                            {   R    D    CLK  Q     } {
                               "0"          {} {   0    1    0    1     }
                   "initial_delay"     { in1 } {   -    0    -    -     }
           "(initial_delay)+setup" { in2 out } {   -    -    1    0     }
...
$tempWT addHbm    setup    min_setup    max_setup    None    independent   { Q pass-fail }   { Q positive-side }   { Q 0.1 -1 }   { Q 1e-11 -1 -1 }  { (fallback_hbm__Q__hl_trig-tout_hbm__Q__hl_targ) (fallback_hbm__Q__hl_targ-tout_hbm__Q__hl_trig) }   {  }  { Q hl }  {  }  { setup_hbm__D__hl__CLK__lh_trig setup_hbm__D__hl__CLK__lh_targ tin__D__hl_trig tin__D__hl_targ tin__CLK__lh_trig tin__CLK__lh_targ tout_hbm__Q__hl_trig tout_hbm__Q__hl_targ } {  } {  } { setup_hbm__D__hl__CLK__lh_value } {  } {  } pass None opt_tolerance (driver_delay_D-driver_delay_CLK)+(1.99*opt_tolerance)+(0.15*(slew_D+slew_CLK)) driver_delay_D-driver_delay_CLK min_setup "1"
