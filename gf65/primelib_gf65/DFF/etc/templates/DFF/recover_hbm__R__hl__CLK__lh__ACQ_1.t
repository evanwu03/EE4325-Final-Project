...
## 
## Test recover_hbm__R__hl__CLK__lh
set tempTest [ SBTest "recover_hbm__R__hl__CLK__lh" ]
$tempTest setTargets { recover_hbm__R__hl__CLK__lh }
...
$tempWT setStimulus                               {   R    D    CLK  Q     } {
                                  "0"          {} {   1    1    0    0     }
                      "initial_delay"     { in1 } {   0    -    -    -     }
           "(initial_delay)+recovery" { in2 out } {   -    -    1    1     }
...
$tempWT addHbm    recovery    min_recovery    max_recovery    None    independent   { Q pass-fail }   { Q positive-side }   { Q 0.1 -1 }   { Q 1e-11 -1 -1 }  { (fallback_hbm__Q__lh_trig-tout_hbm__Q__lh_targ) (fallback_hbm__Q__lh_targ-tout_hbm__Q__lh_trig) }   {  }  { Q lh }  {  }  { recover_hbm__R__hl__CLK__lh_trig recover_hbm__R__hl__CLK__lh_targ tin__R__hl_trig tin__R__hl_targ tin__CLK__lh_trig tin__CLK__lh_targ tout_hbm__Q__lh_trig tout_hbm__Q__lh_targ } {  } {  } { recover_hbm__R__hl__CLK__lh_value } {  } {  } pass None opt_tolerance (driver_delay_R-driver_delay_CLK)+(1.99*opt_tolerance)+(0.15*(slew_R+slew_CLK)) driver_delay_R-driver_delay_CLK min_recovery "1"
