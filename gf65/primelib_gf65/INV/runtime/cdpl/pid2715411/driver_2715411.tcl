...
set_config_opt -- cdpl_log_subdir pid2715411
...
if {[catch {
  ...
  reset_log_file
  if { [log_num_errors] > 0 } {
    if { [catch {exec mv -f $sis_log_file /home/010/e/eb/ebw220000/cad/EE4325_UART_Project/gf65/primelib_gf65/INV/runtime/cdpl/pid2715411} mv_err] } {
      log_warning $mv_err
    }
  } else {
