...
# Date Wed, 07 May 2025 21:43:44 CDT #
#                                                                            #
...
## 
## Formal Ports
$tempTestColl makeFormalPorts {OUT VSS INA VDD}
...
$tempWT setInterface { INA OUT:inout } { initial_delay units ct default_slew pp energy_change_threshold energy_change_abs_threshold }

$tempWT setStimulus                  {   INA  OUT   } {
                   "0"            {} {   0    Z,1   }
...
$tempWT bindInterface { INA OUT } { 10e-12 INA[cycle_time] INA[cycle_time] INA[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
