...
$tempAcq setState "OUT&!INA&!INB&!INC"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { INC INA INB OUT:out } { initial_delay units ct default_slew gate_leakage_multiplication_factor trailing_delay pp }
...
$tempWT addMeasurements {} {
  { leakage_current      leakage_power { (0)+initial_delay+(gate_leakage_multiplication_factor*pp) (0)+initial_delay+(gate_leakage_multiplication_factor*pp)+pp {INA INB INC} {} } NO_USER SYS }
}

$tempWT bindInterface { INC INA INB OUT } { cell_initial_delay None[cycle_time] None[cycle_time] None[default_slew] gate_leakage_time_scaling_factor cell_trailing_delay cell_power_period }
