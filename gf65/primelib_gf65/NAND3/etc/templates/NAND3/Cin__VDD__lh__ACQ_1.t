...
$tempAcq setState "!INA&!INB&!INC&!OUT&!VSS"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { VDD VSS INA INB INC } { initial_delay units ct default_slew pp }

$tempWT setStimulus            {   VDD  VSS  INA  INB  INC   } {
                   "0"      {} {   0    0    0    0    0     }
       "initial_delay" { in1 } {   1    -    -    -    -     }
"(initial_delay)+(pp)"      {} {   -    -    -    -    -     }
}
...
$tempWT bindInterface { VDD VSS INA INB INC } { 10e-12 VDD[cycle_time] VDD[cycle_time] VDD[default_slew] cell_power_period }
