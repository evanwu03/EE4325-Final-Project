...
# Host Name: engnx05a.utdallas.edu, User Name: ebw220000, PID: 1476931 #
# Directory: /home/010/e/eb/ebw220000/cad/EE4325_UART_Project/gf65/primelib_gf65 #
# Date Thu, 08 May 2025 13:32:35 CDT #
#                                                                            #
...
## 
## Formal Ports
$tempTestColl makeFormalPorts {VSS VDD INC INA INB OUT}
...
$tempWT setInterface { INC INA INB OUT:inout } { initial_delay units ct default_slew pp energy_change_threshold energy_change_abs_threshold }

$tempWT setStimulus                  {   INC  INA  INB  OUT   } {
                   "0"            {} {   0    1    1    Z,1   }
...
$tempWT bindInterface { INC INA INB OUT } { 10e-12 INC[cycle_time] INC[cycle_time] INC[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
