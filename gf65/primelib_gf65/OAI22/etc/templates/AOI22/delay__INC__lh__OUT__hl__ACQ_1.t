...
## 
## Test delay__INC__lh__OUT__hl
set tempTest [ SBTest "delay__INC__lh__OUT__hl" ]
$tempTest setTargets { delay__INC__lh__OUT__hl Cin__INC__lh Tout__OUT__hl cap_energy__OUT__hl energy1__INC__lh__OUT__hl__VDD energy1__INC__lh__OUT__hl__VSS energy__INC__lh__OUT__hl leakage_power1__VDD leakage_power1__VSS leakage_power2__VDD leakage_power2__VSS }
...
$tempAcq setState "IND&!INA&!INB"
$tempAcq setStateCoverage "1"
$tempAcq setAdditionalStateCoverage "1" "energy1__INC__lh__OUT__hl__VDD"
$tempAcq setAdditionalStateCoverage "1" "energy__INC__lh__OUT__hl"
$tempAcq setAdditionalStateCoverage "1" "leakage_power2__VSS"
$tempAcq setAdditionalStateCoverage "1" "leakage_power1__VSS"
$tempAcq setAdditionalStateCoverage "1" "energy1__INC__lh__OUT__hl__VSS"
...
$tempWT addMeasurements {} {
  { tin_INC              Tin        { INC start } NO_USER SYS }
  { cin_INC              Cin        { INC start } NO_USER SYS }
  { tout_OUT             Tout       { OUT out } NO_USER SYS }
  { delay_INC_OUT        delay      { INC start OUT out } NO_USER SYS }
  { energy__INC__lh__OUT__hl energy     { start pp energy_change_threshold energy_change_abs_threshold 0 } NO_USER SYS }
  { cell_power_period    export_expr { pp } }
  { energy1__INC__lh__OUT__hl__VDD energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 VDD } }
  ...
  { energy1__INC__lh__OUT__hl__VSS energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 VSS } }
...
$tempWT bindInterface { IND INC INA INB OUT } { 10e-12 INC[cycle_time] INC[cycle_time] INC[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
