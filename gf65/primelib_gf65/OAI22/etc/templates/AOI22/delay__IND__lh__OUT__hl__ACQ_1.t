...
# Host Name: engnx05a.utdallas.edu, User Name: ebw220000, PID: 2626025 #
# Directory: /home/010/e/eb/ebw220000/cad/EE4325_UART_Project/gf65/primelib_gf65 #
# Date Thu, 08 May 2025 14:27:35 CDT #
#                                                                            #
...
## 
## Formal Ports
$tempTestColl makeFormalPorts {VSS VDD IND OUT INA INB INC}
...
## 
## Test delay__IND__lh__OUT__hl
set tempTest [ SBTest "delay__IND__lh__OUT__hl" ]
$tempTest setTargets { delay__IND__lh__OUT__hl Cin__IND__lh Tout__OUT__hl cap_energy__OUT__hl energy1__IND__lh__OUT__hl__VDD energy1__IND__lh__OUT__hl__VSS energy__IND__lh__OUT__hl leakage_power1__VDD leakage_power1__VSS leakage_power2__VDD leakage_power2__VSS }
...
$tempAcq setState "INC&!INA&!INB"
$tempAcq setStateCoverage "1"
$tempAcq setAdditionalStateCoverage "1" "energy1__IND__lh__OUT__hl__VDD"
...
$tempAcq setAdditionalStateCoverage "1" "energy1__IND__lh__OUT__hl__VSS"
$tempAcq setAdditionalStateCoverage "1" "energy__IND__lh__OUT__hl"
...
$tempWT setInterface { IND INC INA INB OUT:inout } { initial_delay units ct default_slew pp energy_change_threshold energy_change_abs_threshold }

$tempWT setStimulus                  {   IND  INC  INA  INB  OUT   } {
                   "0"            {} {   0    1    0    0    Z,1   }
...
$tempWT addMeasurements {} {
  { tin_IND              Tin        { IND start } NO_USER SYS }
  { cin_IND              Cin        { IND start } NO_USER SYS }
  { tout_OUT             Tout       { OUT out } NO_USER SYS }
  { delay_IND_OUT        delay      { IND start OUT out } NO_USER SYS }
  { energy__IND__lh__OUT__hl energy     { start pp energy_change_threshold energy_change_abs_threshold 0 } NO_USER SYS }
  { cell_power_period    export_expr { pp } }
  { energy1__IND__lh__OUT__hl__VDD energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 VDD } }
  ...
  { energy1__IND__lh__OUT__hl__VSS energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 VSS } }
...
$tempWT bindInterface { IND INC INA INB OUT } { 10e-12 IND[cycle_time] IND[cycle_time] IND[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
