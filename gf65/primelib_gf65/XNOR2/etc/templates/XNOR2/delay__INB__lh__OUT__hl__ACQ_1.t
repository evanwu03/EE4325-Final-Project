...
# Date Thu, 08 May 2025 13:55:38 CDT #
#                                                                            #
...
## 
## Formal Ports
$tempTestColl makeFormalPorts {OUT VSS INA INB VDD}
...
$tempWT setInterface { INA INB OUT:inout } { initial_delay units ct default_slew pp energy_change_threshold energy_change_abs_threshold }

$tempWT setStimulus                  {   INA  INB  OUT   } {
                   "0"            {} {   0    0    Z,1   }
...
$tempWT bindInterface { INA INB OUT } { 10e-12 INB[cycle_time] INB[cycle_time] INB[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
