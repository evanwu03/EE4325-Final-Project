...
$tempAcq setState "!INA&!INB&!OUT&!VSS"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { VSS VDD INB INA } { initial_delay units ct default_slew pp }

$tempWT setStimulus            {   VSS  VDD  INB  INA   } {
                   "0"      {} {   0    0    0    0     }
       "initial_delay" { in1 } {   -    1    -    -     }
"(initial_delay)+(pp)"      {} {   -    -    -    -     }
}
...
$tempWT bindInterface { VSS VDD INB INA } { 10e-12 VDD[cycle_time] VDD[cycle_time] VDD[default_slew] cell_power_period }
