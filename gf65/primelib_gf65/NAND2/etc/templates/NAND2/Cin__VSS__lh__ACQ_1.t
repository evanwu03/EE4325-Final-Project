...
$tempAcq setState "!INA&!INB&!OUT&!VDD"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { VSS INA INB VDD } { initial_delay units ct default_slew pp }

$tempWT setStimulus            {   VSS  INA  INB  VDD   } {
                   "0"      {} {   0    0    0    0     }
       "initial_delay" { in1 } {   1    -    -    -     }
"(initial_delay)+(pp)"      {} {   -    -    -    -     }
}
...
$tempWT bindInterface { VSS INA INB VDD } { 10e-12 VSS[cycle_time] VSS[cycle_time] VSS[default_slew] cell_power_period }
